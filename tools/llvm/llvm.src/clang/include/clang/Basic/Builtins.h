...
enum LanguageID {
  ...
  OCLC30_LANG = 0x100, // builtin for OpenCL C 3.0 only.
  ALL_LANGUAGES = C_LANG | CXX_LANG | OBJC_LANG, // builtin for all languages.
  ALL_GNU_LANGUAGES = ALL_LANGUAGES | GNU_LANG,  // builtin requires GNU mode.
  ALL_MS_LANGUAGES = ALL_LANGUAGES | MS_LANG,    // builtin requires MS mode.
  OCLC20_30_LANGUAGES = OCLC20_LANG | OCLC30_LANG, // builtin for OpenCL C 2.0 and 3.0.
  ALL_OCLC_LANGUAGES = OCLC1X_LANG | OCLC20_LANG | OCLC30_LANG // builtin for OCLC languages.
};
