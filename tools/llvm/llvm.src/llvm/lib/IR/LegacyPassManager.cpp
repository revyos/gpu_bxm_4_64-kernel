...
cl::opt<bool> PrintBeforeAll("print-before-all",
                                    llvm::cl::desc("Print IR before each pass"),
                                    cl::init(false), cl::Hidden);
cl::opt<bool> PrintAfterAll("print-after-all",
...
void PMTopLevelManager::schedulePass(Pass *P) {
  ...
  if ((!PI && PrintBeforeAll) || (PI && !PI->isAnalysis() && shouldPrintBeforePass(PI->getPassArgument()))) {
  ...
  if ((!PI && PrintAfterAll) || (PI && !PI->isAnalysis() && shouldPrintAfterPass(PI->getPassArgument()))) {
    Pass *PP = P->createPrinterPass(
