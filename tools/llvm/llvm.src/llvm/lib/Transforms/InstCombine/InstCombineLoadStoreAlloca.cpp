...
// Disabled because this will convert "load <2 x float>" into "load i64"
// among other similar transformations. This causes problems for LowerPtrCasts
// because we need to undo this since local memory vector indexing is
// per-component thus the stores are not equivalent. Also breaks MemOptPass
// because i64 aren't burst-loaded (as of writing this).
#if 0
