...
static bool isEqualImpl(SimpleValue LHS, SimpleValue RHS) {
  ...
  // Instructions that do not agree in precision potentially produce different
  // values and therefore shall be considered distinct.
  bool IsLHSOfMediumPrec = LHSI->getMetadata("mediumPrecision");
  bool IsRHSOfMediumPrec = RHSI->getMetadata("mediumPrecision");
  if (IsLHSOfMediumPrec != IsRHSOfMediumPrec)
    return false;
