...
if( UNIX AND NOT (BEOS OR HAIKU OR ANDROID_DIRECT) )
...
# library checks
if (ANDROID_DIRECT)
  set(HAVE_PTHREAD_GETSPECIFIC TRUE)
  set(HAVE_PTHREAD_RWLOCK_INIT TRUE)
  set(HAVE_PTHREAD_MUTEX_LOCK TRUE)
  set(HAVE_PTHREAD_GETNAME_NP TRUE)
  set(HAVE_PTHREAD_SETNAME_NP TRUE)
  set(HAVE_LIBDL TRUE)
elseif( NOT PURE_WINDOWS )
...
if( HAVE_DLFCN_H )
  if( HAVE_LIBDL AND NOT ANDROID_DIRECT)
