...
enum unspec {
  ...
  UNSPEC_MSA_ADDVI = 220,
  UNSPEC_MSA_ANDI_B = 221,
  UNSPEC_MSA_ASUB_S = 222,
  UNSPEC_MSA_ASUB_U = 223,
  UNSPEC_MSA_AVE_S = 224,
  UNSPEC_MSA_AVE_U = 225,
  UNSPEC_MSA_AVER_S = 226,
  UNSPEC_MSA_AVER_U = 227,
  UNSPEC_MSA_BCLR = 228,
  UNSPEC_MSA_BCLRI = 229,
  UNSPEC_MSA_BINSL = 230,
  UNSPEC_MSA_BINSLI = 231,
  UNSPEC_MSA_BINSR = 232,
  UNSPEC_MSA_BINSRI = 233,
  UNSPEC_MSA_BMNZ_V = 234,
  UNSPEC_MSA_BMNZI_B = 235,
  UNSPEC_MSA_BMZ_V = 236,
  UNSPEC_MSA_BMZI_B = 237,
  UNSPEC_MSA_BNEG = 238,
  UNSPEC_MSA_BNEGI = 239,
  UNSPEC_MSA_BSEL_V = 240,
  UNSPEC_MSA_BSELI_B = 241,
  UNSPEC_MSA_BSET = 242,
  UNSPEC_MSA_BSETI = 243,
  UNSPEC_MSA_BNZ_V = 244,
  UNSPEC_MSA_BZ_V = 245,
  UNSPEC_MSA_BNZ = 246,
  UNSPEC_MSA_BZ = 247,
  UNSPEC_MSA_CFCMSA = 248,
  UNSPEC_MSA_CMPI = 249,
  UNSPEC_MSA_COPY_S = 250,
  UNSPEC_MSA_COPY_U = 251,
  UNSPEC_MSA_CTCMSA = 252,
  UNSPEC_MSA_DOTP_S = 253,
  UNSPEC_MSA_DOTP_U = 254,
  UNSPEC_MSA_DPADD_S = 255,
  UNSPEC_MSA_DPADD_U = 256,
  UNSPEC_MSA_DPSUB_S = 257,
  UNSPEC_MSA_DPSUB_U = 258,
  UNSPEC_MSA_FCAF = 259,
  UNSPEC_MSA_FCLASS = 260,
  UNSPEC_MSA_FCUNE = 261,
  UNSPEC_MSA_FEXDO = 262,
  UNSPEC_MSA_FEXP2 = 263,
  UNSPEC_MSA_FEXUPL = 264,
  UNSPEC_MSA_FEXUPR = 265,
  UNSPEC_MSA_FFINT_S = 266,
  UNSPEC_MSA_FFINT_U = 267,
  UNSPEC_MSA_FFQL = 268,
  UNSPEC_MSA_FFQR = 269,
  UNSPEC_MSA_FILL = 270,
  UNSPEC_MSA_FLOG2 = 271,
  UNSPEC_MSA_FMAX = 272,
  UNSPEC_MSA_FMAX_A = 273,
  UNSPEC_MSA_FMIN = 274,
  UNSPEC_MSA_FMIN_A = 275,
  UNSPEC_MSA_FRCP = 276,
  UNSPEC_MSA_FRINT = 277,
  UNSPEC_MSA_FRSQRT = 278,
  UNSPEC_MSA_FSAF = 279,
  UNSPEC_MSA_FSEQ = 280,
  UNSPEC_MSA_FSLE = 281,
  UNSPEC_MSA_FSLT = 282,
  UNSPEC_MSA_FSNE = 283,
  UNSPEC_MSA_FSOR = 284,
  UNSPEC_MSA_FSUEQ = 285,
  UNSPEC_MSA_FSULE = 286,
  UNSPEC_MSA_FSULT = 287,
  UNSPEC_MSA_FSUN = 288,
  UNSPEC_MSA_FSUNE = 289,
  UNSPEC_MSA_FTINT_S = 290,
  UNSPEC_MSA_FTINT_U = 291,
  UNSPEC_MSA_FTRUNC_S = 292,
  UNSPEC_MSA_FTRUNC_U = 293,
  UNSPEC_MSA_FTQ = 294,
  UNSPEC_MSA_HADD_S = 295,
  UNSPEC_MSA_HADD_U = 296,
  UNSPEC_MSA_HSUB_S = 297,
  UNSPEC_MSA_HSUB_U = 298,
  UNSPEC_MSA_ILVEV = 299,
  UNSPEC_MSA_ILVL = 300,
  UNSPEC_MSA_ILVOD = 301,
  UNSPEC_MSA_ILVR = 302,
  UNSPEC_MSA_INSERT = 303,
  UNSPEC_MSA_INSVE = 304,
  UNSPEC_MSA_MADD_Q = 305,
  UNSPEC_MSA_MADDR_Q = 306,
  UNSPEC_MSA_MAX_A = 307,
  UNSPEC_MSA_MAX_S = 308,
  UNSPEC_MSA_MAX_U = 309,
  UNSPEC_MSA_MAXI_S = 310,
  UNSPEC_MSA_MAXI_U = 311,
  UNSPEC_MSA_MIN_A = 312,
  UNSPEC_MSA_MIN_S = 313,
  UNSPEC_MSA_MIN_U = 314,
  UNSPEC_MSA_MINI_S = 315,
  UNSPEC_MSA_MINI_U = 316,
  UNSPEC_MSA_MSUB_Q = 317,
  UNSPEC_MSA_MSUBR_Q = 318,
  UNSPEC_MSA_MUL_Q = 319,
  UNSPEC_MSA_MULR_Q = 320,
  UNSPEC_MSA_NLOC = 321,
  UNSPEC_MSA_NLZC = 322,
  UNSPEC_MSA_NORI_B = 323,
  UNSPEC_MSA_ORI_B = 324,
  UNSPEC_MSA_PCKEV = 325,
  UNSPEC_MSA_PCKOD = 326,
  UNSPEC_MSA_PCNT = 327,
  UNSPEC_MSA_SAT_S = 328,
  UNSPEC_MSA_SAT_U = 329,
  UNSPEC_MSA_SHF = 330,
  UNSPEC_MSA_SLD = 331,
  UNSPEC_MSA_SLDI = 332,
  UNSPEC_MSA_SLLI = 333,
  UNSPEC_MSA_SPLAT = 334,
  UNSPEC_MSA_SPLATI = 335,
  UNSPEC_MSA_SRAI = 336,
  UNSPEC_MSA_SRAR = 337,
  UNSPEC_MSA_SRARI = 338,
  UNSPEC_MSA_SRLI = 339,
  UNSPEC_MSA_SRLR = 340,
  UNSPEC_MSA_SRLRI = 341,
  UNSPEC_MSA_SUBS_S = 342,
  UNSPEC_MSA_SUBS_U = 343,
  UNSPEC_MSA_SUBSUU_S = 344,
  UNSPEC_MSA_SUBSUS_U = 345,
  UNSPEC_MSA_SUBVI = 346,
  UNSPEC_MSA_TSTNZ_V = 347,
  UNSPEC_MSA_TSTZ_V = 348,
  UNSPEC_MSA_TSTNZ = 349,
  UNSPEC_MSA_TSTZ = 350,
  UNSPEC_MSA_VSHF = 351,
  UNSPEC_MSA_XORI_B = 352,
  UNSPEC_MSA_CAST_TO_SCALAR = 353,
  UNSPEC_MSA_CAST_TO_VECTOR = 354,
  UNSPEC_ADDRESS_FIRST = 355
};
#define NUM_UNSPEC_VALUES 356
...
#define NUM_PROCESSOR_VALUES 46
