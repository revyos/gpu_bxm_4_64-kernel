...
#define HAVE_msa_insve_s_insn_h (ISA_HAS_MSA)
#define HAVE_msa_insve_s_insn_b (ISA_HAS_MSA)
#define HAVE_msa_insve_u_insn_w (ISA_HAS_MSA)
#define HAVE_msa_insve_u_insn_h (ISA_HAS_MSA)
#define HAVE_msa_insve_u_insn_b (ISA_HAS_MSA)
...
#define HAVE_msa_lsa (ISA_HAS_LSA)
...
#define HAVE_movti_msa (ISA_HAS_MSA \
   && !TARGET_64BIT \
   && (register_operand (operands[0], TImode) \
       || reg_or_0_operand (operands[1], TImode)))
#define HAVE_movti_msa_64bit (ISA_HAS_MSA \
   && TARGET_64BIT \
   && (register_operand (operands[0], TImode) \
       || reg_or_0_operand (operands[1], TImode)))
#define HAVE_movv2df_msa (ISA_HAS_MSA \
   && (register_operand (operands[0], V2DFmode) \
       || reg_or_0yi_operand (operands[1], V2DFmode)))
#define HAVE_movv4sf_msa (ISA_HAS_MSA \
   && (register_operand (operands[0], V4SFmode) \
       || reg_or_0yi_operand (operands[1], V4SFmode)))
#define HAVE_movv2di_msa (ISA_HAS_MSA \
   && (register_operand (operands[0], V2DImode) \
       || reg_or_0yi_operand (operands[1], V2DImode)))
#define HAVE_movv4si_msa (ISA_HAS_MSA \
   && (register_operand (operands[0], V4SImode) \
       || reg_or_0yi_operand (operands[1], V4SImode)))
#define HAVE_movv8hi_msa (ISA_HAS_MSA \
   && (register_operand (operands[0], V8HImode) \
       || reg_or_0yi_operand (operands[1], V8HImode)))
#define HAVE_movv16qi_msa (ISA_HAS_MSA \
   && (register_operand (operands[0], V16QImode) \
       || reg_or_0yi_operand (operands[1], V16QImode)))
...
#define HAVE_floatv2dfv2di2 (ISA_HAS_MSA)
#define HAVE_floatv4sfv4si2 (ISA_HAS_MSA)
#define HAVE_floatunsv2dfv2di2 (ISA_HAS_MSA)
#define HAVE_floatunsv4sfv4si2 (ISA_HAS_MSA)
...
#define HAVE_msa_ilvev_d (ISA_HAS_MSA)
...
#define HAVE_msa_ilvod_d (ISA_HAS_MSA)
...
#define HAVE_msa_max_s_d (ISA_HAS_MSA)
#define HAVE_msa_max_s_w (ISA_HAS_MSA)
#define HAVE_msa_max_s_h (ISA_HAS_MSA)
#define HAVE_msa_max_s_b (ISA_HAS_MSA)
#define HAVE_msa_max_u_d (ISA_HAS_MSA)
#define HAVE_msa_max_u_w (ISA_HAS_MSA)
#define HAVE_msa_max_u_h (ISA_HAS_MSA)
#define HAVE_msa_max_u_b (ISA_HAS_MSA)
...
#define HAVE_msa_min_s_d (ISA_HAS_MSA)
#define HAVE_msa_min_s_w (ISA_HAS_MSA)
#define HAVE_msa_min_s_h (ISA_HAS_MSA)
#define HAVE_msa_min_s_b (ISA_HAS_MSA)
#define HAVE_msa_min_u_d (ISA_HAS_MSA)
#define HAVE_msa_min_u_w (ISA_HAS_MSA)
#define HAVE_msa_min_u_h (ISA_HAS_MSA)
#define HAVE_msa_min_u_b (ISA_HAS_MSA)
...
#define HAVE_movsf 1
#define HAVE_movdf 1
#define HAVE_movti (TARGET_64BIT || TARGET_MSA)
...
extern rtx        gen_msa_insve_s_insn_h              (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_msa_insve_s_insn_b              (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_msa_insve_u_insn_w              (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_msa_insve_u_insn_h              (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_msa_insve_u_insn_b              (rtx, rtx, rtx, rtx, rtx);
...
extern rtx        gen_msa_lsa                         (rtx, rtx, rtx, rtx);
...
extern rtx        gen_movti_msa                       (rtx, rtx);
extern rtx        gen_movti_msa_64bit                 (rtx, rtx);
...
extern rtx        gen_floatv2dfv2di2                  (rtx, rtx);
extern rtx        gen_floatv4sfv4si2                  (rtx, rtx);
extern rtx        gen_floatunsv2dfv2di2               (rtx, rtx);
extern rtx        gen_floatunsv4sfv4si2               (rtx, rtx);
...
extern rtx        gen_msa_ilvev_d                     (rtx, rtx, rtx);
...
extern rtx        gen_msa_ilvod_d                     (rtx, rtx, rtx);
...
extern rtx        gen_msa_max_s_d                     (rtx, rtx, rtx);
extern rtx        gen_msa_max_s_w                     (rtx, rtx, rtx);
extern rtx        gen_msa_max_s_h                     (rtx, rtx, rtx);
extern rtx        gen_msa_max_s_b                     (rtx, rtx, rtx);
extern rtx        gen_msa_max_u_d                     (rtx, rtx, rtx);
extern rtx        gen_msa_max_u_w                     (rtx, rtx, rtx);
extern rtx        gen_msa_max_u_h                     (rtx, rtx, rtx);
extern rtx        gen_msa_max_u_b                     (rtx, rtx, rtx);
...
extern rtx        gen_msa_min_s_d                     (rtx, rtx, rtx);
extern rtx        gen_msa_min_s_w                     (rtx, rtx, rtx);
extern rtx        gen_msa_min_s_h                     (rtx, rtx, rtx);
extern rtx        gen_msa_min_s_b                     (rtx, rtx, rtx);
extern rtx        gen_msa_min_u_d                     (rtx, rtx, rtx);
extern rtx        gen_msa_min_u_w                     (rtx, rtx, rtx);
extern rtx        gen_msa_min_u_h                     (rtx, rtx, rtx);
extern rtx        gen_msa_min_u_b                     (rtx, rtx, rtx);
