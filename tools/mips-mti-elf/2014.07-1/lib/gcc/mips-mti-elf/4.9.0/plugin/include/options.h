...
enum opt_code
{
  ...
  OPT_mfpxx = 1106,                          /* -mfpxx */
  OPT_mfused_madd = 1107,                    /* -mfused-madd */
  OPT_mgp32 = 1108,                          /* -mgp32 */
  OPT_mgp64 = 1109,                          /* -mgp64 */
  OPT_mgpopt = 1110,                         /* -mgpopt */
  OPT_mhard_float = 1111,                    /* -mhard-float */
  OPT_mimadd = 1112,                         /* -mimadd */
  OPT_minterlink_compressed = 1113,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1114,              /* -minterlink-mips16 */
  OPT_mips = 1115,                           /* -mips */
  OPT_mips16 = 1116,                         /* -mips16 */
  OPT_mips3d = 1117,                         /* -mips3d */
  OPT_mllsc = 1118,                          /* -mllsc */
  OPT_mload_store_pairs = 1119,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1120,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1121,                    /* -mlong-calls */
  OPT_mlong32 = 1122,                        /* -mlong32 */
  OPT_mlong64 = 1123,                        /* -mlong64 */
  OPT_mlra = 1124,                           /* -mlra */
  OPT_mmad = 1125,                           /* -mmad */
  ...
  OPT_modd_spreg = 1138,                     /* -modd-spreg */
  ...
  OPT_msched_weight = 1143,                  /* -msched-weight */
  OPT_mshared = 1144,                        /* -mshared */
  OPT_msingle_float = 1145,                  /* -msingle-float */
  OPT_msmartmips = 1146,                     /* -msmartmips */
  OPT_msoft_float = 1147,                    /* -msoft-float */
  OPT_msplit_addresses = 1148,               /* -msplit-addresses */
  OPT_msym32 = 1149,                         /* -msym32 */
  OPT_msynci = 1150,                         /* -msynci */
